...
class PanelInterfaceConfigBuffer:
    def __init__(
        self,
        hub: PanelInterfaceConfigHub,
        process: PanelInterface,
        /,
        *,
        ...
        self._initial_config: PanelInterfaceConfig = self._hub.load()
        self._configs: dict[str, PanelInterfaceConfig] = {}
    ...
    def _get_config(self, session_id: str, /) -> PanelInterfaceConfig:
